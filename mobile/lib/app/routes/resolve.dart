...
class _ResolveScreenState extends State<ResolveScreen> {
  ...
  Future<void> _handleResolve() async {
    ...
    try {
      final data = await ApiService.resolve(url, _selectedPlatform!);
            ...
            child: ConstrainedBox(
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Paste a Spotify, Apple Music, YouTube Music link...',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: canResolve ? _handleResolve : null,
