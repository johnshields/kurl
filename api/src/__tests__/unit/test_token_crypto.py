"""
Tests for utils.auth.token_crypto -- only the pure-Python guard paths. The
...
from utils.auth import token_crypto


class TestIsConfigured:
    def test_false_when_no_key(self):
        with patch("utils.auth.token_crypto.settings") as mock_settings:
