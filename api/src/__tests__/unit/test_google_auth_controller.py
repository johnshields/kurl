"""
Tests for api.controllers.oauth.google_auth_controller -- Sign in with YouTube,
both anonymous (find-or-create) and linked (an existing session) modes.
"""

from unittest.mock import AsyncMock, patch

from api.controllers.oauth import google_auth_controller
...
class TestHandleCallback:
    ...
    async def test_redirects_with_error_when_token_exchange_fails(self):
        with patch("api.controllers.oauth.oauth_signin.settings") as mock_settings:
            ...
            with patch(
                "api.controllers.oauth.google_auth_controller.google_oauth_client.exchange_code",
    ...
    async def test_links_to_existing_session_when_state_carries_a_subject(self):
        ...
        with patch("api.controllers.oauth.oauth_signin.settings") as mock_settings:
            ...
            with patch(
                ...
                "api.controllers.oauth.google_auth_controller.google_oauth_client.fetch_profile",
